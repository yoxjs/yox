...
export function bind(node: HTMLElement | YoxInterface, directive: Directive, vnode: VNode) {
  ...
  watcher: Watcher<YoxInterface> | void = function (newValue: any, _: any, keypath: string) {
  ...
  vnode.context.watch(binding, watcher as Watcher<YoxInterface>)

  vnode.data[directive.key] = function () {
    vnode.context.unwatch(binding, watcher as Watcher<YoxInterface>)
