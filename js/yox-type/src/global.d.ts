...
import { data, dataGenerator, bind, unbind, on, off, enter, leave, getter, setter, watcher, listener, filter, component, componentCallback, optionsBeforeCreateHook, optionsOtherHook, routerBeforeHook, routerAfterHook, API, PropRule, Computed, Observer, Emitter, CustomEvent, ValueHolder, VNode } from './type';
declare const Yox: {
    prototype: Yox;
    dom: API;
    is: isUtil;
